...
# Portable compatibility build. Convenient as one file, but slower to launch
# because PyInstaller must unpack its embedded runtime before starting Python.
exe = EXE(
    pyz,
    a.scripts,
    a.binaries,
